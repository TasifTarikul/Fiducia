...
class Journey(models.Model):
    ...
    depart_area_name = models.CharField(max_length=50, null=True, blank=True)
...
class Order(models.Model):
    ...
    order_creation_date = models.DateTimeField(null=True, blank=True, auto_now_add=True)
    url = models.CharField(max_length=3000, null=True, blank=True)
    package_image = models.ImageField(upload_to=update_filename, null=True, blank=True)
    package_weight = models.FloatField(null=True, blank=True)
    package_description = models.CharField(max_length=3000, null=True, blank=True)
    delivery_price = models.FloatField(null=True, blank=True)
    delivery_date = models.DateField(null=True, blank=True)
    cyber_product_price = models.FloatField(null=True, blank=True)
